...
<div class="single-our-services-section extra-small-padding">
    <div class="container">
...
<div class="service-cta-section medium-padding mt-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2 class="main-heading-white">Add a CTA Here</h2>
                ...
                <?php for ($i = 0; $i < 3; $i++): ?>
                    <div class="cta-item mb-4">
                        ...
                        <div class="d-inline-block align-middle description">
                            <h3 class="mb-0">Dedicated project manager</h3>
                        </div>
                    </div>
                <?php endfor; ?>
...
<div class="faqs-section text-center medium-padding">
    <div class="faqs-wrapper container">
        <h2 class="main-heading">FAQS</h2>
        <p class="w-75 mx-auto main-content mb-5">Our SEO packages are designed to help you get your business found online.
...
<div class="blog-featured-section mb-5">
    <div class="container">
        <h2 class="text-center main-heading mb-2">Resources</h2>
        <p class="text-center main-content mb-4">Not ready to buy, check out these great resources related to SEO</p>
